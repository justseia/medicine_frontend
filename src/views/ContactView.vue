<template>
    <div class="page-title-area">
        ...
        <img src="@/assets/images/page-shape-1.png" class="shape page-shape-1" alt="Image" />
        <img src="@/assets/images/page-shape-2.png" class="shape page-shape-2" alt="Image" />
    </div>
                            ...
                            <div class="form-check">
                                <div class="form-group">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="gridCheck"> Я согласен с <a href="terms-conditions.html">условиями</a> и <a href="privacy-policy.html">политикой конфиденциальности</a> </label>
